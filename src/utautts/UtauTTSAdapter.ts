...
export class UtauTTSAdapter {
     ...
     */
    public async synthesizeText(bank: VoiceBank, text: string, tone: string = "C4", modelJSON: string = "", features: Record<string, number>[] = []): Promise<Float32Array | null> {
        ...
        const request = {
            ...
            frames: features, // TCN イントネーション予測用の言語特徴量
        };
